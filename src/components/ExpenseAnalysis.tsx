...
export function ExpenseAnalysis({ transactions }: ExpenseAnalysisProps) {
  ...
  const getWeeklyData = () => {
    const last4Weeks = Array.from({ length: 4 }, (_, i) => {
      ...
      return {
        week: `Week ${4 - i}`,
        expenses: Math.abs(weekTransactions
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-4 rounded-lg shadow-lg">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <ComposedChart data={getMonthlyData()}>
            ...
            <Bar dataKey="expenses" fill="#FF8042" name="Expenses" />
            <Bar dataKey="revenue" fill="#00C49F" name="Revenue" />
            <Line type="monotone" dataKey="expenses" stroke="#FF8042" dot={false} />
          </ComposedChart>
        </ResponsiveContainer>
      </div>
      ...
      {/* Current Week Daily Expenses */}
      <div className="bg-white p-4 rounded-lg shadow-lg">
        <h3 className="text-lg font-semibold mb-4">Current Week Daily Expenses</h3>
        <ResponsiveContainer width="100%" height={300}>
      ...
      <div className="bg-white p-4 rounded-lg shadow-lg">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <ComposedChart data={getExpenseTrendData()}>
            ...
            <Tooltip />
            <Legend />
            <Area type="monotone" dataKey="expenses" fill="#FF8042" stroke="#FF8042" />
            <Area type="monotone" dataKey="revenue" fill="#00C49F" stroke="#00C49F" />
      ...
      <div className="bg-white p-4 rounded-lg shadow-lg">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="p-4 bg-blue-50 rounded-lg">
            <h4 className="text-sm font-medium text-blue-700">Total Income</h4>
          ...
          <div className="p-4 bg-green-50 rounded-lg">
            <h4 className="text-sm font-medium text-green-700">Net Balance</h4>
          ...
          <div className="p-4 bg-purple-50 rounded-lg">
            <h4 className="text-sm font-medium text-purple-700">Transactions</h4>
